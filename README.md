...
4. **`FundamentalsSyncService`**: Fetches real fundamental financial statements and ratios by ISIN from Upstox REST endpoints (`/v2/fundamentals/{isin}/income-statement`, `/key-ratios`, `/share-holdings`) and stores profiles in `FundamentalsRepository`.
